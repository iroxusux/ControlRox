...
from pyrox.models.gui.meta import ObjectEditField
...
class PlcGuiObject(PyroxGuiObject):
    ...
    def from_data(
        ...
        if isinstance(data, plc.RaDatatype):
            return DatatypeGuiObject(datatype=data)
        if isinstance(data, plc.RaModule):
...
class DatatypeGuiObject(PlcGuiObject):
    ...
    def __init__(self, datatype: plc.RaDatatype = None, **kwargs):
...
class ModuleGuiObject(PlcGuiObject):
    ...
    def __init__(self, module: plc.RaModule = None, **kwargs):
