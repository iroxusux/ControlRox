...
from controlrox.models.plc.rockwell.connection import (
...
class TestControllerConnection(unittest.TestCase):
    ...
    @patch('controlrox.models.plc.rockwell.connection.PLC')
    ...
    def test_run_commands_when_disconnected(self):
        ...
        with patch('controlrox.models.plc.rockwell.connection.PLC') as mock_plc:
            connection._run_commands()
