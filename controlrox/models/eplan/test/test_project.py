...
from controlrox.models.eplan.project import (
    EplanProjectDevice,
    EplanNetworkDevice,
    EplanProject,
    EplanProjectFactory,
...
from controlrox.models.eplan import meta
from controlrox.models.plc.rockwell import RaController, RaModule
...
class TestEplanProject(unittest.TestCase):
    ...
    @patch('controlrox.models.eplan.project.dict_from_xml_file')
    def test_init_with_params(self, mock_dict_from_xml):
        """Test EplanProject initialization with parameters."""
        mock_controller = Mock()

        with patch('controlrox.models.eplan.project.rename_keys'):
    ...
    @patch('controlrox.models.eplan.project.dict_from_xml_file')
    @patch('controlrox.models.eplan.project.rename_keys')
    ...
    @patch('controlrox.models.eplan.project.log')
...
class TestEplanControllerValidator(unittest.TestCase):
    ...
    def test_find_matching_module_in_project_found(self):
        ...
        mock_module = Mock(spec=RaModule)
    ...
    def test_project_parsing_workflow(self):
        ...
        with patch.object(project, '_gather_project_device_io_details'):
            with patch.object(project, '_gather_project_ethernet_devices'):
                ...
                with patch('controlrox.models.eplan.project.dict_from_xml_file', return_value=self.sample_meta_data):
                    with patch('controlrox.models.eplan.project.rename_keys'):
                        project.file_location = "test.epj"

                # Parse the project
                with patch('controlrox.models.eplan.project.log'):
                    project.parse()
