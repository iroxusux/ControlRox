...
class RoutineTask(ControllerApplicationTask):
    ...
    def debug_draw(self):
        ...
        self.application.workspace.register_frame(ladder_frame, raise_frame=True)
    ...
    def generate_default_routine(self):
        ...
        routine = self.application.controller.create_routine(
            name='DefaultRoutine',
            description='Generated by Pyrox Programming Application.'
        )

        ladder_frame = ladder_gui.task_frame.LadderEditorTaskFrame(
